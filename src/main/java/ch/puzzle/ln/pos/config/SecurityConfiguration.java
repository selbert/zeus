...
import ch.puzzle.ln.pos.security.jwt.JWTConfigurer;
import ch.puzzle.ln.pos.security.jwt.TokenProvider;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
        http
            ...
            .antMatchers("/api/lnd/**").permitAll()
            .antMatchers("/api/bitcoin/**").permitAll()
